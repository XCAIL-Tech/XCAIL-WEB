...
const es = {
  ...
  products: {
    ...
    asistea: {
      ...
      screenshots: [
        ...
        { src: "/media/productos/asistea/01_AsisTEA_Panel_Familiar.png", label: "Panel familiar" },
        { src: "/media/productos/asistea/02_AsisTEA_Acompanamiento_Personalizado_IA.png", label: "Acompañamiento personalizado con IA" },
        { src: "/media/productos/asistea/03_AsisTEA_Espacio_de_Aprendizaje.png", label: "Espacio de aprendizaje" },
        { src: "/media/productos/asistea/04_AsisTEA_Espacio_Sensorial.png", label: "Espacio sensorial" },
        { src: "/media/productos/asistea/05_AsisTEA_Agenda_y_Organizacion.png", label: "Agenda y organización" },
      ],
    },
    ohm: {
      badge: "Disponible",
      ...
      screenshots: [
        ...
        { src: "/media/productos/incluxia-connect/01-INCLUXIA-CONNECT-Plataforma-Web.png", label: "Plataforma web" },
        { src: "/media/productos/incluxia-connect/02-INCLUXIA-CONNECT-Comunicacion-Accesible.png", label: "Comunicación accesible" },
        { src: "/media/productos/incluxia-connect/03-INCLUXIA-CONNECT-Alerta-SOS.png", label: "Alerta SOS" },
        { src: "/media/productos/incluxia-connect/04-INCLUXIA-CONNECT-Notas-Expresion-Personal.png", label: "Notas y expresión personal" },
        { src: "/media/productos/incluxia-connect/05-INCLUXIA-CONNECT-Mensajeria-Red-de-Apoyo.png", label: "Mensajería con la red de apoyo" },
      ],
    },
    stroke: {
      badge: "En desarrollo",
      ...
      screenshots: [
        { src: "/media/productos/incluxia-stroke/00-INCLUXIA-STROKE-Reconocimiento-y-Respuesta.png", label: "Reconocimiento y respuesta" },
      ],
    },
  },
  pricing: {
  ...
  about: {
    ...
    founder_role: "Founder & CEO — XCAIL Technologies",
    founder_bio: [
      "Carlos Ezequiel Leiva es fundador y CEO de XCAIL Technologies, una startup enfocada en el desarrollo de productos de inteligencia artificial aplicados al neurodesarrollo, accesibilidad y tecnologías de apoyo.",
      "Con experiencia en ciencia de datos, inteligencia artificial y sistemas tecnológicos, lidera el diseño y desarrollo de soluciones digitales orientadas a ampliar autonomía, organización y comunicación para personas neurodivergentes, familias e instituciones.",
      "Su trabajo integra inteligencia artificial generativa, automatización, analítica de datos y arquitectura cloud para construir productos tecnológicos escalables con impacto real.",
      "Actualmente lidera el desarrollo de AsisTEA, una plataforma orientada al acompañamiento inteligente en neurodesarrollo, e INCLUXIA, la plataforma de tecnología accesible de XCAIL que reúne a Connect (comunicador AAC, disponible) y Stroke (reconocimiento de señales de ACV, en desarrollo).",
    ],
    linkedin_btn: "Ver LinkedIn",
    company_linkedin: "LinkedIn Corporativo",
  ...
  contact: {
    ...
    address: "Nicaragua 4817, Ciudad Autónoma de Buenos Aires (CP 1414), República Argentina",
...
const en: typeof es = {
  ...
  products: {
    ...
    asistea: {
      ...
      screenshots: [
        ...
        { src: "/media/productos/asistea/01_AsisTEA_Panel_Familiar.png", label: "Family panel" },
        { src: "/media/productos/asistea/02_AsisTEA_Acompanamiento_Personalizado_IA.png", label: "AI-personalized support" },
        { src: "/media/productos/asistea/03_AsisTEA_Espacio_de_Aprendizaje.png", label: "Learning space" },
        { src: "/media/productos/asistea/04_AsisTEA_Espacio_Sensorial.png", label: "Sensory space" },
        { src: "/media/productos/asistea/05_AsisTEA_Agenda_y_Organizacion.png", label: "Schedule & organization" },
      ],
    },
    ohm: {
      badge: "Available",
      ...
      screenshots: [
        ...
        { src: "/media/productos/incluxia-connect/01-INCLUXIA-CONNECT-Plataforma-Web.png", label: "Web platform" },
        { src: "/media/productos/incluxia-connect/02-INCLUXIA-CONNECT-Comunicacion-Accesible.png", label: "Accessible communication" },
        { src: "/media/productos/incluxia-connect/03-INCLUXIA-CONNECT-Alerta-SOS.png", label: "SOS alert" },
        { src: "/media/productos/incluxia-connect/04-INCLUXIA-CONNECT-Notas-Expresion-Personal.png", label: "Notes & personal expression" },
        { src: "/media/productos/incluxia-connect/05-INCLUXIA-CONNECT-Mensajeria-Red-de-Apoyo.png", label: "Support-network messaging" },
      ],
    },
    stroke: {
      ...
      screenshots: [
        { src: "/media/productos/incluxia-stroke/00-INCLUXIA-STROKE-Reconocimiento-y-Respuesta.png", label: "Recognition and response" },
      ],
    },
  },
  pricing: {
  ...
  about: {
    ...
    founder_role: "Founder & CEO — XCAIL Technologies",
    founder_bio: [
      "Carlos Ezequiel Leiva is the founder and CEO of XCAIL Technologies, a startup focused on developing artificial intelligence products applied to neurodevelopment, accessibility, and assistive technologies.",
      "With experience in data science, artificial intelligence, and technology systems, he leads the design and development of digital solutions aimed at expanding autonomy, organization, and communication for neurodivergent individuals, families, and institutions.",
      "His work integrates generative artificial intelligence, automation, data analytics, and cloud architecture to build scalable technology products with real-world impact.",
      "He currently leads the development of AsisTEA, a platform focused on intelligent neurodevelopment support, and INCLUXIA, XCAIL's accessible technology platform — Connect (AAC communicator, available) and Stroke (stroke warning-sign recognition, in development).",
    ],
  ...
  contact: {
    ...
    address: "Nicaragua 4817, Buenos Aires City (CP 1414), Argentina",
    legal_name: "XCAIL Technologies SAS",
    cuit_label: "Tax ID",
    cuit: "30-71921679-6",
  },
